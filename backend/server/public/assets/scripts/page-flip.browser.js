!(function (t, e) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    ? define(["exports"], e)
    : e(
        ((t = "undefined" != typeof globalThis ? globalThis : t || self).St =
          {})
      );
})(this, function (t) {
  "use strict";
  ...
  class i extends e {
    ...
    simpleDraw(t) {
      const e = this.render.getRect(),
        ...
        o = e.top;
      this.isLoad
        ? i.drawImage(this.image, h, o, s, n)
        : this.drawLoader(i, { x: h, y: o }, s, n);
    }
    drawLoader(t, e, i, s) {
      t.beginPath(),
  ...
  class s {
    ...
    createSpread() {
      ...
      let t = 0;
      this.isShowCover &&
        (this.pages[0].setDensity("hard"), this.landscapeSpread.push([t]), t++);
      for (let e = t; e < this.pages.length; e += 2)
        e < this.pages.length - 1
          ? this.landscapeSpread.push([e, e + 1])
          : (this.landscapeSpread.push([e]), this.pages[e].setDensity("hard"));
    }
    getSpread() {
  ...
  class h {
    ...
    static GetCordsFromTwoPoint(t, e) {
      ...
      for (let r = 1; r <= n; r += 1)
        h.push({ x: o(t.x, e.x, i, n, r), y: o(t.y, e.y, s, n, r) });
      return h;
    }
  }
  class o extends e {
  ...
  class a {
    ...
    checkPositionAtCenterLine(t, e, i) {
      ...
      if (
        ("bottom" === this.corner &&
          ((r = this.rect.topRight), (a = this.rect.bottomLeft)),
        r.x <= 0)
      ) {
  ...
  class g {
    ...
    flipNext(t) {
      this.flip({
        x:
          this.render.getRect().left + 2 * this.render.getRect().pageWidth - 10,
      ...
      return (
        "stretch" === this.setting.size
          ? (e < 2 * this.setting.minWidth &&
            ...
            (o = h / n),
            o > this.getBlockHeight() &&
              ((o = this.getBlockHeight()), (h = o * n)),
            (r = "portrait" === t ? i - h / 2 - h : i - h))
          : e < 2 * h &&
            this.app.getSettings().usePortrait &&
            ((t = "portrait"), (r = i - h / 2 - h)),
        (this.boundsRect = {
          left: r,
          top: s - o / 2,
          width: 2 * h,
        ...
        "portrait" === t
          ? (this.app.getSettings().autoSize &&
              (this.wrapper.style.paddingBottom =
                (this.app.getSettings().height / this.app.getSettings().width) *
                  100 +
                "%"),
      ...
      for (const t of r) {
        let e =
          1 === this.getDirection()
            ...
            : { x: t.x - this.shadow.pos.x, y: t.y - this.shadow.pos.y };
        (e = h.GetRotatedPoint(e, { x: i, y: 100 }, o)),
          (a += e.x + "px " + e.y + "px, ");
      }
      (a = a.slice(0, -2)), (a += ")");
      const g = `\n            display: block;\n            z-index: ${(
